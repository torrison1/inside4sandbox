<div class="container">
    <div class="row">
        <div class="cul-xs-10 cul-xs-offset-1">
            ...
            <p>Сайт – личный сайт (укажите принадлежность сайта), расположенный в сети Интернет по адресу: www.укажите домен сайта.</p>
            <p>Администрация Сайта – укажите юридическую форму образования (ИП, ООО и т.п.), контакты.</p>
            ...
            <p>2.6. При внесении изменений в Политику конфиденциальности, Администрация Сайта уведомляет об этом Пользователя путём размещения новой редакции Политики конфиденциальности на Сайте www.укажите домен сайта.</p>
            ...
            <h4>3. УСЛОВИЯ И ЦЕЛИ СБОРА И ОБРАБОТКИ ПЕРСОНАЛЬНЫХ ДАННЫХ ПОЛЬЗОВАТЕЛЕЙ</h4>

            <p>3.1. Персональные данные Пользователя такие как: имя, фамилия, отчество, e-mail, телефон, skype и др., передаются Пользователем  Администрации Сайта с согласия Пользователя.
            <p>3.2. Передача персональных данных Пользователем Администрации Сайта, через Форму обратной связи  означает согласие Пользователя на передачу его персональных данных.
            ...
            <ul>
                ...
                <li>сведения о дате выдачи указанного документа и выдавшем его органе;
                <li>дату регистрации через Форму обратной связи;
                <li>текст запроса в свободной форме;
                <li>подпись Пользователя или его представителя.
            </ul>
